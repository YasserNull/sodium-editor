...
/**
 * TextArabicUtils provides utility methods for handling Arabic and RTL text. This includes: -
 * Detecting Arabic script in text - Checking for mixed direction text - Identifying RTL and Latin
 * script blocks
 */
