...
public class Caret {
  ...
  public void drawCaret(Canvas canvas) {
    ...
    float x = editor.cursorAnimation.cursorDrawX;
    float y = editor.cursorAnimation.cursorDrawY;
  ...
  public float getCaretX() {
    ...
    return editor.getTextStartX() + editor.measureTextWithVisualSpaces(lineText, 0, safeChar, editor.textRender.paint) - editor.scroll.scrollX;
  }
