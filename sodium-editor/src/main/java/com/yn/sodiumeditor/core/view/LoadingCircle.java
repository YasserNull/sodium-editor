...
public class LoadingCircle {
  ...
  // Setters
  public void setLoadingCircleRadius(float r) {
    if (r > 0) loadingCircleRadius = r;
    syncToAnimation();
  }

  public void setLoadingCircleColor(int c) {
    loadingCircleColor = c;
    syncToAnimation();
  }

  public void setLoadingCircleStrokeWidth(float w) {
    if (w > 0) loadingCircleStrokeWidth = w;
    syncToAnimation();
  }

  public void setShowLoadingOnFileOpen(boolean e) {
    showLoadingOnFileOpen = e;
    syncToAnimation();
  }
}
