 ...
 * This includes:
 * - Lookup tables for byte tokens
 * - Byte-to-visible string conversion
 * - Token span caching
...
public class BinaryTokenConverter {
    ...
    public boolean isBinaryHexTokensEnabled() { return binaryHexTokensEnabled; }
    ...
    public boolean isBinaryCaretNotationEnabled() { return binaryCaretNotationEnabled; }
    ...
    private static final ThreadLocal<StringBuilder> TL_SB = ThreadLocal.withInitial(() -> new StringBuilder(8192));
