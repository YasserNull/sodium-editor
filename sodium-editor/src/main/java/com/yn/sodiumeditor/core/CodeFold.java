...
public class CodeFold {
    ...
    public void rebuildFoldIntervalsIfNeeded() {
        ...
        if (clampToKnownLines) {
            ...
            if (totalLines <= 0) {
                totalLines = editor.textRender.windowStartLine + editor.textRender.linesWindow.size();
            }
    ...
    private int getFoldAwareTotalLines() {
        ...
        int windowEnd = editor.textRender.windowStartLine + editor.textRender.linesWindow.size();
