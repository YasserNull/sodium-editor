...
public class HighlightRules {
    ...
    private void initWhitespaceRules() {
        ...
        whitespaceCommentRule = new HighliteRender.HighlightRule("", com.yn.sodiumeditor.core.view.FontStyle.STYLE_NORMAL, 0xFF000000, size, tf, false, HighliteRender.HighlightRuleType.BLOCK_COMMENT);
    }
    ...
    if (globalLine >= editor.windowRender.windowStartLine && globalLine < editor.windowRender.windowStartLine + editor.windowRender.linesWindow.size()) {
