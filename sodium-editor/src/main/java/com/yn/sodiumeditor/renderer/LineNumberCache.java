...
public class LineNumberCache {
  ...
  public boolean shouldUseCache() {
    return lineNumber.showLineNumbers
  ...
  public void ensureBitmap(int width, int height) {
    if (lineNumber.lineNumberCacheBitmap != null
        ...
        && lineNumber.lineNumberCacheHeight == height) return;
  ...
  public boolean needsRebuild(
      int width, int height, int first, int last, float baseY, boolean wrapped) {
    return lineNumber.lineNumberCacheBitmap == null
        ...
        || Math.abs(lineNumber.lineNumberCacheGutterWidth - lineNumber.lineNumbersGutterWidth)
            > 0.1f
