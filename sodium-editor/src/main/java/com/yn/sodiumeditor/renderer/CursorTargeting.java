    ...
    public com.yn.sodiumeditor.core.EditorTextInserter.CursorTarget getCursorTargetForPosition(
        ...
        com.yn.sodiumeditor.utils.WrapWordUtils.VisualLinePosition pos =
                view.wrapWordState.isWordWrapEnabled
                        ? view.wrapWordMapper.getVisualPositionForIndex(view, visualIndex, Math.max(1, Math.round(view.getWidth() - view.lineNumberRenderer.getTextStartX(view.editorConfig.paddingLeft, view.isRtl))))
        ...
        int[] starts = view.wrapWordEngine.getWrapStartsForLine(view, pos.line, line, Math.max(1, Math.round(view.getWidth() - view.lineNumberRenderer.getTextStartX(view.editorConfig.paddingLeft, view.isRtl))), view.editorConfig.paint);
