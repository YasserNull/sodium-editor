...
public class Undo {
  ...
  public void execute() {
    ...
    if (op.removedText == null
        && (op.entireFileDelete || op.insertedText == null || op.insertedText.isEmpty())) {
  ...
  private String describeOp(EditOp op) {
    ...
    return "range="
        ...
        + (op.removedTextBackupFile == null
            ? "<null>"
            : op.removedTextBackupFile.getAbsolutePath());
  }
}
